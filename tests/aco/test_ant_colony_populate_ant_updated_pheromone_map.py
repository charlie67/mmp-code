...
class TestAntColonyPopulateAntUpdatedPheromoneMap(unittest.TestCase):
    ...
    def test_first_run_two_ants(self):
        ...
        self.assertTrue(
            test_object.ant_updated_pheromone_map[1][2] < .9 and test_object.ant_updated_pheromone_map[1][2] >= (.83))
        ...
        self.assertTrue(
            test_object.ant_updated_pheromone_map[2][1] < .9 and test_object.ant_updated_pheromone_map[1][2] >= (.83))
    ...
    def test_two_ants(self):
        ...
        self.assertTrue(
            test_object.ant_updated_pheromone_map[1][2] < 1.9 and test_object.ant_updated_pheromone_map[1][2] >= (1.83))
        ...
        self.assertTrue(
            test_object.ant_updated_pheromone_map[2][1] < 1.9 and test_object.ant_updated_pheromone_map[1][2] >= (1.83))
